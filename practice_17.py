...
def binary_search(sorted_list, numb, left, right):
    ...
    if numb > sorted_list[-1]:
        index_1 = sorted_list[-1]
        print("справа от числа с индексом", index_1, "отсутсвуют другие числа")
            ...
            if index_1 < 0:
                print("слева от числа с индексом", index_2, "отсутствуют другие числа")
            elif numb > sorted_list[-1]:
                print("справа от числа с индексом", index_1, "отсутсвуют другие числа")
            else:
